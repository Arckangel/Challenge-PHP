        ...
        <div class="row">
          <div class="col-xs-12 text-center">
            ...
            if ($match==true) {
              ...
              $res1 = mysqli_query($cnx,"UPDATE contact SET pseudo='$pseudo',prenom='$prenom',date_naiss='$date_naiss',email='$email',jeux='$jeux',image='$image',valide=0 WHERE id=$id");
              echo "L'utilisateur' a bien été modifié<br>";
              echo '<br><a href="admin.php"><button class="btn btn-default" type="button" name="button">Retour</button></a>';
            }
            else {
              echo "Erreur lors de la modification de l'utilisateur<br>Veuillez remplir les champs correctement<br>";
              echo '<br><a href="admin.php"><button class="btn btn-default" type="button" name="button">Retour</button></a>';
            }
            ?>
            <br><br><br><br>
